            ...
            try
            {
                foreach (var property in jsonObject.Properties())
                {
                    ...
                    var labelObject = new
                    {
                        ...
                        XPos = (double?)item["XPos"] ?? 0,
                        YPos = (double?)item["YPos"] ?? 0,
                        BCStyle = (int?)item["BCStyle"] ?? 0,
                        BCWidth = (double?)item["BCWidth"] ?? 0,
                        BCHeight = (double?)item["BCHeight"] ?? 0,
                        Order = (int)item["Order"],
                        ForeColor = (string)item["ForeColor"],
                        BackColor = (string)item["BackColor"],
                        FontSize = (double?)item["FontSize"] ?? 0,
                        ...
                        FontOrientation = (int?)item["FontOrientation"] ?? 0,
                        Alignment = (int?)item["Alignment"],
                        BCBarWidth = (double?)item["BCBarWidth"] ?? 0,
                        BCDirection = (int?)item["BCDirection"] ?? 0,
                        BCUPCNotches = (int?)item["BCUPCNotches"] ?? 0,
                        StartChar = (int?)item["StartChar"] ?? 0,
                        MaxLen = (int?)item["MaxLen"] ?? 0,
                        SpecialFunctions = (int?)item["SpecialFunctions"] ?? 0
                    };
