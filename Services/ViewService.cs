...
namespace MSRecordsEngine.Services
{
    ...
    public sealed class ViewService
    {
        ...
        //    if (RemoveTableNameFromField(sFieldName) == "SLTrackedDestination" | RemoveTableNameFromField(sFieldName) == "SLFileRoomOrder")
        //    {
        ...
        //    oFields = ViewService.FieldWithOrWithoutTable(sFieldName, rsADO.Fields, false);
        //    if (rsADO.State != (int)Enums.ObjectStateEnum.rmStateClosed)
        //    {
        //        if (oFields is not null)
        //        {
        //            if (IsADateType((Enums.DataTypeEnum)oFields.Type))
        //            {
        //                msFieldType = Common.FT_DATE;
        //                msFieldSize = Common.FT_DATE_SIZE;
        //            }
        //            else if (IsAStringType((Enums.DataTypeEnum)oFields.Type))
        //            {
        ...
        //                switch (oFields.Type)
        //                {
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmBoolean:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmUnsignedTinyInt:
        //                        {
        //                            msFieldType = Common.FT_BOOLEAN;
        //                            msFieldSize = Common.FT_BOOLEAN_SIZE;
        //                            break;
        //                        }
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmDouble:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmCurrency:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmDecimal:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmNumeric:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmSingle:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmVarNumeric:
        //                        {
        //                            msFieldType = Common.FT_DOUBLE;
        //                            msFieldSize = Common.FT_DOUBLE_SIZE;
        //                            break;
        //                        }
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmBigInt:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmUnsignedBigInt:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmInteger:
        //                        {
        ...
        //                            {
        //                                if (!string.IsNullOrEmpty(oTables.CounterFieldName) & Strings.StrComp(RemoveTableNameFromField(oFields.Name), RemoveTableNameFromField(oTables.IdFieldName), Constants.vbTextCompare) == 0)
        //                                {
        ...
        //                            break;
        //                        }
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmBinary:
        //                        {
        //                            msFieldType = Common.FT_BINARY;
        //                            msFieldSize = Common.FT_MEMO_SIZE;
        //                            break;
        //                        }
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmSmallInt:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmTinyInt:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmUnsignedInt:
        //                    case (DataTypeEnum)Enums.DataTypeEnum.rmUnsignedSmallInt:
        //                        {
        ...
        //                {
        //                    FieldWithOrWithoutTableRet = oFields[RemoveTableNameFromField(sFieldName)];
        ...
        //public static bool DataLocked_old(string sFieldName, ADODB.Recordset rsADO)
        //{
        ...
        //            oField = ViewService.FieldWithOrWithoutTable(sFieldName, rsADO.Fields, false);

        //            if (oField is not null)
        //            {
        //                if (Convert.ToBoolean(((int)oField.Attributes & (int)Enums.FieldAttributeEnum.rmFldUpdatable) == 0 && ((int)oField.Attributes & (int)Enums.FieldAttributeEnum.rmFldUnknownUpdatable) == 0))
        //                    IsLock = true;
        ...
        //public static bool DataLocked(string sFieldName, string table)
        //{
        ...
        //    var sci = SchemaInfoDetails.GetColumnsSchema(table).Where(a => a.COLUMN_NAME.ToLower() == sFieldName.ToLower()).FirstOrDefault();
        //    bool IsLock = false;
        //    try
        //    {
        //        if (sci is not null)
        ...
        //                        {
        //                            tableName = RemoveFieldNameFromField(oFilterColumns.FieldName);
        //                        }
        ...
        //                        var oSchemaColumnList = SchemaInfoDetails.GetSchemaInfo(tableName, RemoveTableNameFromField(oFilterColumns.FieldName));
        ...
        //                            if (Strings.StrComp(oSchemaColumn.ColumnName, RemoveTableNameFromField(oFilterColumns.FieldName), Constants.vbTextCompare) == 0)
        //                            {
        //                                break;
        //                            }
        //                        }
        ...
        public static bool CreateCoalesceFields(List<Table> cTables, IQueryable<Databas> cDatabase, ref string sFields, bool bIncludeAS = true)
        {
            ...
            foreach (Table oTmpTables in cTables)
            {
                ...
                if (string.IsNullOrEmpty(sFieldNameOne))
                    sFieldNameOne = RemoveTableNameFromField(oTmpTables.IdFieldName);
                if (!string.IsNullOrEmpty(sPrefixOne))
                    sFields += "'" + sPrefixOne + " ' + ";
                oSchemaColumns = SchemaInfoDetails.GetSchemaInfo(oTmpTables.TableName, sFieldNameOne).Where(m => m.ColumnName.Trim().ToLower().Equals(sFieldNameOne.Trim().ToLower())).FirstOrDefault();
                ...
                {
                    sFields += " + ' " + sPrefixTwo + " ' + ";
                    oSchemaColumns = SchemaInfoDetails.GetSchemaInfo(oTmpTables.TableName, sFieldNameTwo).Where(m => m.ColumnName.Trim().ToLower().Equals(sFieldNameTwo.Trim().ToLower())).FirstOrDefault();
            ...
            if (!string.IsNullOrEmpty(sFields))
            {
                ...
                if (bIncludeAS)
                    sFields += " AS " + ReportsService.TRACKED_LOCATION_NAME;
                        ...
                        foreach (var oViewFilters in cViewFilters)
                        {
                            ...
                            if ((bool)oViewFilters.Active)
                            {
                                ...
                                if (oViewFilters.ColumnNum > -1)
                                {
                                    ...
                                    {
                                        sFieldName = RemoveTableNameFromField(oViewColumns.FieldName);
                                        ...
                                        if (oTables is not null)
                                        {
                                            oSchemaColumns = SchemaInfoDetails.GetSchemaInfo(oTables.TableName, sFieldName).Where(m => m.ColumnName.Trim().ToLower().Equals(sFieldName.Trim().ToLower())).FirstOrDefault();
                                            ...
                                            else if (Strings.StrComp(RemoveTableNameFromField(sFieldName), ReportsService.TRACKED_LOCATION_NAME, Constants.vbTextCompare) == 0)
                                            {
                                                bIsStringCol = true;
                                                bIsDateCol = false;
                                                bIsMemoCol = false;
                                                ...
                                                cUsedTables = ViewService.GetUsedTrackingTables(oTables, cTables.Where(m => m.TrackingTable > 0));
                                ...
                                else
                                {
                                    ...
                                    var oTableSchemaColumn = SchemaInfoDetails.GetSchemaInfo(oTable.TableName, oTable.IdFieldName).Where(m => m.ColumnName.Trim().ToLower().Equals(oTable.IdFieldName.Trim().ToLower())).FirstOrDefault();
                                    if (oTableSchemaColumn is not null)
                                    {
                                        bIsStringCol = IsAStringType(oTableSchemaColumn.DataType);
                                        bIsDateCol = IsADateType(oTableSchemaColumn.DataType);
                                    }

                                    bIsMemoCol = false;
                                    bIsCheckBoxCol = false;
                                    sLookupTableName = "";
                                    sFieldName = RemoveTableNameFromField(oTable.IdFieldName);
                                }
