...
{
    public class SLAuditFailedLoginMap : EntityTypeConfiguration<SLAuditFailedLogin>
    {
        public SLAuditFailedLoginMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            
            // Table & Column Mappings
            this.ToTable("SLAuditFailedLogins");
            ...
            this.Property(t => t.ReasonForFailure).HasColumnName("ReasonForFailure");
            this.Property(t => t.TextEntered).HasColumnName("TextEntered");
